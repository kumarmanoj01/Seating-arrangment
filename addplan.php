	...
	<div id="container">
		...
		<div class="sidebar">
			...
			<ul id="nav">
				...
				<li><a class="Adds"href="seatplan.php">Seatplan</a>
					<ul>
						<li><a class="Adds1"href="addplan.php">Add-Seatplan</a></li>
						<li><a class="Adds2"href="viewplan.php">View-Seatplan</a></li>
					</ul>
				</li>
				<li><a class="views"href="operation.html">Operation</a></li>
			</ul>
		</div>
		<div class="content">
			<h1>Add-Seat Plan</h1>
			<p>my para</p>
			<div id="box">
				<div class="box-top">C Language Introduction</div>
				<div class="box-panel">This is my styl</div>
