	...
	<div id="container">
		...
		<div class="sidebar">
			...
			<ul id="nav">
				...
				<li><a class="Department"href="Department.php">Department</a>
					<ul>
						<li><a class="Department1"href="adddept.php">Add Department</a></li>
						<li><a class="Department2"href="viewdept.php">View Department</a></li>
					</ul>
				</li>
		...
		<div class="content">
			<font color="#f39c12"><h1>Add Department</h1></font>
			<div id="box">
				...
				<div class="box-panel">
					 <form action="adddept.php" method="post">
						...
						<table   style="padding-left:50px">
							<tr ><td><h4>Department Name</h4></td><td style="padding-left:20px"><input type="text" name="dn" autofocus="1"></td></tr>
							<tr >
								<td><h4>Status</h4>
							...
							<tr style="padding-top:20px"><td></td><td style="padding-top:20px"><input type="Submit" name="adddept" value="Add Department" align="right"></td></tr>
						</table>
